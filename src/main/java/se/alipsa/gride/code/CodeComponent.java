...
import se.alipsa.gride.code.javatab.JavaTab;
import se.alipsa.gride.code.jstab.JsTab;
import se.alipsa.gride.code.mdtab.MdTab;
import se.alipsa.gride.code.sqltab.SqlTab;
import se.alipsa.gride.code.txttab.TxtTab;
import se.alipsa.gride.code.xmltab.XmlTab;
...
public class CodeComponent extends BorderPane {
  ...
  public CodeComponent(Gride gui) {
    this.gui = gui;
