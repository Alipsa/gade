...
import se.alipsa.gride.utils.JdbcDriverDependencyUtils;
    ...
    */
    ...
    try {
      ...
      try {
        ...
        if (Gride.instance().getPrefs().getBoolean(USE_MAVEN_CLASSLOADER, false) && Gride.instance().getInoutComponent().hasPomFile()) {
          ...
          if (addToPom) {
            ...
            try {
              ...
              gui.getConsoleComponent().initGroovy(gui.getClass().getClassLoader(), true);
