...
import static se.alipsa.gride.utils.git.GitUtils.asRelativePath;
...
import se.alipsa.gride.inout.git.AddRemoteDialog;
import se.alipsa.gride.inout.git.ConfigResult;
import se.alipsa.gride.inout.git.CredentialsDialog;
import se.alipsa.gride.inout.git.GitConfigureDialog;
import se.alipsa.gride.inout.git.GitStatusDialog;
...
public class DynamicContextMenu extends ContextMenu {
   ...
   public DynamicContextMenu(FileTree fileTree, Gride gui, InoutComponent inoutComponent) {
