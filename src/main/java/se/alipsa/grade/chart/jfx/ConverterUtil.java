...
public class ConverterUtil {
  ...
  public static void populateVerticalSeries(XYChart<?,?> fxChart, se.alipsa.grade.chart.Chart data) {
  ...
  public static void populateHorizontalSeries(XYChart<?,?> fxChart, se.alipsa.grade.chart.Chart data) {
    var series = data.getValueSeries();
    var categories = data.getCategorySeries();
    for (var column : series) {
      XYChart.Series fxSeries = new XYChart.Series();
