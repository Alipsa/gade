...
import se.alipsa.grade.inout.git.AddRemoteDialog;
import se.alipsa.grade.inout.git.ConfigResult;
...
public class DynamicContextMenu extends ContextMenu {
   ...
   public DynamicContextMenu(FileTree fileTree, Grade gui, InoutComponent inoutComponent) {
