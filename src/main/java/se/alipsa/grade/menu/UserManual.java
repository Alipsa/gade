...
public class UserManual {
  ...
  public UserManual(Grade gui) {
    ...
    featuresButton = new Button("Grade features");
    featuresButton.getStyleClass().add(NORMAL_BUTTON);
    featuresButton.setOnAction(e -> loadPage(featuresUrl, featuresButton));

    rideShortCuts = new Button("Grade keyboard shortcuts");
    rideShortCuts.getStyleClass().add(NORMAL_BUTTON);
    rideShortCuts.setOnAction(e -> loadPage(shortcutsUrl, rideShortCuts));

    interactingWithGradeButton = new Button("Interacting with Grade");
    interactingWithGradeButton.getStyleClass().add(NORMAL_BUTTON);
    interactingWithGradeButton.setOnAction(e -> loadPage(interactionUrl, interactingWithGradeButton));
    ...
    linkPane.getChildren().addAll(featuresButton, rideShortCuts, interactingWithGradeButton, packagesButton, examplesButton);
  ...
  void clearButtonStyles() {
    ...
    clearButtonStyle(interactingWithGradeButton);
