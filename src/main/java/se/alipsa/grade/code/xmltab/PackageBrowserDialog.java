...
import static se.alipsa.grade.Constants.FLOWPANE_INSETS;
import static se.alipsa.grade.utils.MavenRepoLookup.metaDataUrl;
...
public class PackageBrowserDialog extends Dialog<Void> {
   ...
   public PackageBrowserDialog(Grade gui) {
