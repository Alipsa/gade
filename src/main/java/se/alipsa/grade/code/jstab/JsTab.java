package se.alipsa.grade.code.jstab;
...
import se.alipsa.grade.console.AppenderWriter;
import se.alipsa.grade.console.ConsoleComponent;
import se.alipsa.grade.console.ConsoleTextArea;
import se.alipsa.grade.console.WarningAppenderWriter;
...
public class JsTab extends TextAreaTab {
  ...
  public JsTab(String title, Grade gui) {
