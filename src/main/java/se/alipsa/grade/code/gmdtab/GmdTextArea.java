...
import se.alipsa.grade.code.TabTextArea;
import se.alipsa.grade.code.TextAreaTab;
import se.alipsa.grade.console.ConsoleComponent;
import se.alipsa.grade.utils.DefaultTaskListener;
...
public class GmdTextArea extends CodeTextArea implements TabTextArea {
   ...
   public GmdTextArea(TextAreaTab parent) {
      super(parent);
      Grade gui = parent.getGui();
