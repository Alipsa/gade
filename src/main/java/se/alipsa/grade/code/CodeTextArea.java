...
import static se.alipsa.grade.Constants.INDENT;
...
import se.alipsa.grade.utils.StringUtils;
    ...
    addEventHandler(KeyEvent.KEY_PRESSED, e -> {
      ...
      if (e.isControlDown()) {
        if (KeyCode.F.equals(keyCode)) {
          Grade.instance().getMainMenu().displayFind();
        } else if (KeyCode.S.equals(keyCode)) {
          Grade.instance().getMainMenu().saveContent(parentTab);
        } else if (e.isShiftDown() && KeyCode.C.equals(keyCode)) {
          Grade.instance().getMainMenu().commentLines();
      ...
      item.setOnAction(actionEvent -> {
        try {
          ...
          if (lastWord.contains(".")) { // We are selecting from a list of methods
            ...
            //Grade.instance().getConsoleComponent().getConsole().appendFx("start is " + start + ", result is " + result, true);
          ...
          //Grade.instance().getConsoleComponent().getConsole().appendFx("result is " + result + ", replacement is " + replacement, true);
