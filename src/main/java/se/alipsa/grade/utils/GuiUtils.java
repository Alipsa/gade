...
public final class GuiUtils {
  ...
  public static void addStyle(Grade gui, Dialog<?> dialog) {
  ...
  public static void addStyle(Grade gui, Stage stage) {
    stage.getIcons().addAll(gui.getStage().getIcons());
  ...
  private static boolean validateDialogNotNull(Grade gui, Object dialog) {
    if (dialog == null) {
      String msg = "GuiUtils.addStyle() : Grade instance is " + gui + ", dialog is null. Called from "
  ...
  public static void addStyle(Grade gui, Parent dialog, int... stacktraceElementOpt) {
    if (validateDialogNotNull(gui, dialog)) return;
  ...
  public static void addStyle(Grade gui, ObservableList<String> styleSheetList, int... stacktraceElementOpt) {
    ...
    if (gui != null && styleSheetList != null ) {
      ...
      String msg = "GuiUtils.addStyle() : Grade instance is " + gui + ", style sheet list is " + styleSheetList + ". Called from "
