 ...
 * <code>
 * SshSessionFactory sshSessionFactory = new GradeSshSessionFactory();
 ...
 * </code>
 */
public class GradeSshSessionFactory extends JschConfigSessionFactory {

  private static final Logger log = LogManager.getLogger();

  String url;

  public GradeSshSessionFactory(String url) {
    log.trace("GradeSshSessionFactory for {}", url);
    this.url = url;
  }
