...
public class UserManual {
  ...
  public UserManual(Gade gui) {
    ...
    featuresButton = new Button("Gade features");
    featuresButton.getStyleClass().add(NORMAL_BUTTON);
    featuresButton.setOnAction(e -> loadPage(featuresUrl, featuresButton));

    rideShortCuts = new Button("Gade keyboard shortcuts");
    rideShortCuts.getStyleClass().add(NORMAL_BUTTON);
    rideShortCuts.setOnAction(e -> loadPage(shortcutsUrl, rideShortCuts));

    interactingWithGadeButton = new Button("Interacting with Gade");
    interactingWithGadeButton.getStyleClass().add(NORMAL_BUTTON);
    interactingWithGadeButton.setOnAction(e -> loadPage(interactionUrl, interactingWithGadeButton));
    ...
    linkPane.getChildren().addAll(featuresButton, rideShortCuts, interactingWithGadeButton, packagesButton, examplesButton);
  ...
  void clearButtonStyles() {
    ...
    clearButtonStyle(interactingWithGadeButton);
